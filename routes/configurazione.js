...
router.get('/configurazione', (req, res) => {
    ...
    res.status(200).render('config', {
        ...
        led: "Area LED",
        infoLED: "In questa area è possibile regolare la luminosità dei LED. Sono previsti 10 livelli per ogni LED.",
        pr: "Area Fotoresistori",
        infoPR: "In questa area è possibile associare uno dei fotoresistori installati ad un LED presente in un ambiente, in modo da regolarne la luminosità in maniera automatica.",
